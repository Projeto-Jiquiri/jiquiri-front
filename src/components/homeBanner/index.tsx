    ...
    return (
        <div className="flex flex-1 flex-col justify-center items-center bg-Dark_Green_Jiquiri mt-8 md:mt-8 lg:mt-12 xl:mt-6 2xl:mt-8">
            ...
            <div className="flex flex-row justify-center items-center max-md:flex-col gap-6 p-8 md:gap-6 md:p-10 lg:gap-16 lg:p-10 xl:gap-20 xl:p-14 2xl:gap-24 2xl:p-16">
                <Button variant='outline' onClick={() => router.push('/projeto-jiquiri')} className="bg-White_Jiquiri hover-card border-Black_Jiquiri border-2 text-Gray_Jiquiri text-lg 2xl:text-lg xl:text-lg lg:text-lg md:text-sm text-center leading-5 shadow-sm tracking-wider font-semibold text-wrap font-catilde rounded-full w-68 h-14 md:w-56 md:h-16 lg:w-68 xl:w-68 lg:h-12 xl:h-12 2xl:w-68 2xl:h-14">Descubra o Projeto Jiquiri</Button>
                <Button variant='outline' onClick={() => router.push('/relatorios')} className="bg-White_Jiquiri hover-card border-Black_Jiquiri border-2 text-Gray_Jiquiri text-lg 2xl:text-lg xl:text-lg lg:text-lg md:text-sm text-center leading-5 shadow-sm tracking-wider font-semibold text-wrap font-catilde rounded-full w-68 h-14 md:w-56 md:h-16 lg:w-68 xl:w-68 lg:h-12 xl:h-12 2xl:w-68 2xl:h-14">Veja os últimos Relatórios</Button>
                <Button variant='outline' onClick={() => router.push('/sobre')} className="bg-White_Jiquiri hover-card border-Black_Jiquiri border-2 text-Gray_Jiquiri text-lg 2xl:text-lg xl:text-lg lg:text-lg md:text-sm text-center leading-5 shadow-sm tracking-wider font-semibold text-wrap font-catilde rounded-full w-68 h-14 md:w-56 md:h-16 lg:w-68 xl:w-68 lg:h-12 xl:h-12 2xl:w-68 2xl:h-14">Detalhes do Projeto Jiquiri</Button>
            </div>
